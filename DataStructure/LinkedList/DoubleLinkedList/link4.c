...
void insertbefore()
{
    ...
    printf("Enter the data before to insert : ");
    scanf("%d", &data);
...
void deleteafter()
{
    ...
    if(curr == NULL) printf("Invalid Data\n");
...
int main(void)
{
    ...
    do
    {
        ...
        printf("12.INSERT BEFORESPECIFIC\n");
        printf("13.DELETE AFTERSPECIFIC\n");
        printf("14.DELETE BEFORESPECIFIC\n");
        printf("0.EXIT\n");
        ...
        switch(op)
	{
            ...
            case 11: insertdescending();
                     break;
            case 12: insertbefore();
                     break;
            case 13: deleteafter();
                     break;
            case 14: deletebefore();
                     break;
             case 0: deleteAll();
                     break;
	}
